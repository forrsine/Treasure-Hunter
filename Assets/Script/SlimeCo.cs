...
public class SlimeCo : MonoBehaviour, FighterInterface
{
    ...
    {
        // 查找玩家对象
        PlayerCo player = GameObject.FindObjectOfType<PlayerCo>();
        if (player != null)
        {
    ...
    private void Reward()
    {
        if (PlayerCo.instance != null)
        {
            PlayerCo.instance.AddExp(Exp);
        }
    }
    ...
    {
        return BoxCo.instance != null ? BoxCo.instance.DestroyedCount : 0;
    }
